...
sha256sums=(
	...
	'9998602501b493acfefcbe8f15096a4c46808dfbfe7bba5b0c30985f2780d4f0'
	'64b2cf77834533ae7bac0c71936087857d8787d0e2a349037795eb7e42d23dde'
)

# extra patches
_extrapatches=(
	"http://www.kernel.org/pub/linux/kernel/v3.x/patch-3.1.1.gz"
)
_extrapatchessums=(
...
build() {
	...
	for patch in ${_extrapatches[@]}; do
		...
		msg2 "apply ${patch}"
		patch -Np1 -i ${srcdir}/${patch} > /dev/null 2>&1
	done
