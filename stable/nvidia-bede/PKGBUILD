...
pkgver=331.38
_extramodules=3.12-BEDE-external
pkgrel=2
pkgdesc="NVIDIA drivers for linux-bede"
arch=('i686' 'x86_64')
url="http://www.nvidia.com/"
makedepends=('linux-bede>=3.12.8' 'linux-bede<3.13' 'linux-bede-headers>=3.12' 'linux-bede-headers<3.13' "nvidia-utils=$pkgver" "nvidia-libgl=$pkgver")
...
if [ "$CARCH" = "i686" ]; then
    ...
    sha256sums=('396e4d8fffacd271937ef57dd90ec2dea3ff32ee9f1de73ce5370a6e29382bf4')
...
package() {
    depends=('linux-bede>=3.12' 'linux-bede<3.13' "nvidia-utils=${pkgver}" "nvidia-libgl=$pkgver")
