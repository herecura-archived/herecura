...
makedepends=('linux-bede>=3.9.8' 'linux-bede<3.10' 'linux-bede-headers>=3.9' 'linux-bede-headers<3.10' "nvidia-utils=$pkgver")
...
package() {
    depends=('linux-bede>=3.9' 'linux-bede<3.10' "nvidia-utils=${pkgver}")
