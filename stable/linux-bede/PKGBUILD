...
sha256sums=(
	...
	'a34d983842bc66395596539470cc3f9d0b42695c9a6b6cd8fd7f96c6783d40e2'
	'd1b6ca5414cbe579ed27a9744ecf7aae30523b2844afb5500a0cc7c4ad9e9a43'
...
package_linux-bede() {
	...
	if [ "$CARCH" = "x86_64" ]; then
		install -m644 -D ${srcdir}/sysctl-desktop.x86_64 ${pkgdir}/etc/sysctl.d/sysctl-${pkgname}.conf
	else
		install -m644 -D ${srcdir}/sysctl-desktop.i686 ${pkgdir}/etc/sysctl.d/sysctl-${pkgname}.conf
	fi
