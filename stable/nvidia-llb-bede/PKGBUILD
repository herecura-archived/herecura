...
makedepends=('linux-bede>=4.0.5-1.1' 'linux-bede<4.1' 'linux-bede-headers>=4.0' 'linux-bede-headers<4.1' "nvidia-utils-llb=$pkgver" "nvidia-libgl-llb=$pkgver")
conflicts=('nvidia')
provides=('nvidia')
license=('custom')
...
package() {
    depends=('linux-bede>=4.0' 'linux-bede<4.1' "nvidia-utils-llb=${pkgver}" "nvidia-libgl-llb=$pkgver")
