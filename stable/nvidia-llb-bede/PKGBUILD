...
makedepends=('linux-bede>=3.4' 'linux-bede<3.5' 'linux-bede-headers>=3.4' 'linux-bede-headers<3.5' "nvidia-llb-utils=${pkgver}")
...
package_nvidia-llb-bede() {
	...
	depends=('linux-bede>=3.4' 'linux-bede<3.5' "nvidia-llb-utils=${pkgver}")
