...
license=('GPL')
makedepends=('libstdc++5' 'bin86' 'dev86' 'iasl' 'libxslt' 'libxml2' 'libpng' 'libidl2' 'xalan-c' 'sdl' 'linux-bede>=3.4.4-3' 'linux-bede<3.5' 'linux-bede-headers>=3.4.4-3' 'linux-bede-headers<3.5')
