...
makedepends=('linux-bede>=3.17.4' 'linux-bede<3.18' 'linux-bede-headers>=3.17' 'linux-bede-headers<3.18' "nvidia-340xx-utils=$pkgver" "nvidia-340xx-libgl=$pkgver" 'clang')
conflicts=('nvidia')
license=('custom')
